...
import { addMyInfo, addSinglePost, addToAllPosts, addUser, deleteThePost } from "./slice";
...
endpoints:(builder)=>({
    ...
    allPost:builder.query({
        ...
        providesTags:(result,error,args)=>{
            return result?[...result.post.map(({_id})=>({type:"Post",id:_id})),{type:'Post',id:'LIST'}] :[{type:'Post',id:'LIST'}]
        },
        async onQueryStarted(params,{dispatch,queryFulfilled}){
            try {
                const {data}=await queryFulfilled;
